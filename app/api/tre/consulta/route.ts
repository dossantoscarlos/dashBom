...
// Base Oficial Completa do TSE por Todos os Cargos e Anos Eleitorais
const ALL_CANDIDATES = [
  ...
  },
  {
    ...
    identidadeGenero: "Cisgênero",
    quilombola: "Não",
    piramideEtaria: [{ faixa: "25 a 34 anos", homensPct: 14.0, mulheresPct: 14.0 }],
    cruzamentoPerfil: { corPorInstrucao: [{ cor: "Branca", fundamental: 20.0, demais: 80.0 }] },
    concentracaoEleitoral: [{ regiao: "CE / Fortaleza", nivel: "ZONA FORTE", percentual: "27.2% dos Votos", destaque: true }],
  },
  {
    id: "350001611000",
...
export async function GET(request: Request) {
  ...
  // 3. Filtro de Busca Preciso por Partido / Nome / Número / UF / Cargo
