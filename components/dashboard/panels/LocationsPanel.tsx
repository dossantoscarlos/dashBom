...
export function LocationsPanel() {
  ...
  return (
    <div className="mx-auto flex max-w-6xl flex-col gap-6">
      <PageHeader
        title="Cadastro de Locais (Comitê)"
        description="Comitês, sedes e pontos de apoio da campanha"
        action={
          <button
            type="button"
            onClick={() => {
      ...
      <DataTable
        ...
        columns={[
          ...
          { key: "type", header: "Tipo", render: (l) => l.type },
          {
            key: "address",
            header: "Endereço",
            render: (l) => (
          ...
          { key: "capacity", header: "Capacidade", render: (l) => l.capacity },
          {
            key: "responsible",
            header: "Responsável",
